...
. ├── sharedmobility_analysis.ipynb # Main analysis notebook ├── snapshots/ # (Optional) directory storing vehicle snapshots ├── inferred_trips.csv # Output dataset of inferred trips ├── supply_heatmap.html # Interactive heatmap of vehicle supply ├── system_map.html # Interactive system-level map └── README.md # Project documentation